...
* 🔐 **Ciberseguridad:** Prevención, análisis de vulnerabilidades y respuesta a incidentes (Blue Team).
* 🧠 **Inteligencia Artificial:** Aplicando IA Generativa y Prompt Engineering para optimizar la seguridad y la productividad.
* 📊 **Análisis de Datos:** Extracción de valor y reportes mediante SQL, Power BI y Excel (Power Query/Pivot).
* 📚 **Aprendizaje Continuo:** Explorando constantemente nuevos protocolos de red y tecnologías aplicadas a la ciberseguridad.
...
> *"La tecnología evoluciona rápido, pero la perseverancia, la actitud junto a la responsabilidad y el compromiso, nunca quedan obsoletos."*
<!--
